...
public class Medicines_Stock extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Medicines_Stock frame = new Medicines_Stock();
	...
	public Medicines_Stock() {
		...
		textField.setBounds(2, 694, 1004, 27);
		...
		label.setIcon(new ImageIcon(Medicines_Stock.class.getResource("/Admin/Logo_164x97.png")));
		...
		button_4.setBounds(915, 10, 81, 30);
