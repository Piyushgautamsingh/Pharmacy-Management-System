...
{ 
 ...
 {
  String Med_id=request.getParameter("delete");
  out.println(Med_id);
  PreparedStatement pstmt=null; 
  
  pstmt=con.prepareStatement("delete from Medicine_stock where Med_id=? "); 
  pstmt.setString(1,Med_id);
  pstmt.executeUpdate(); 
  out.print(Med_id+ "Deleted");
  con.close(); 
 }
}
catch(Exception e)
...
%>
  <a href="Medicine_stock.jsp">Back</a>
</body>
</html>