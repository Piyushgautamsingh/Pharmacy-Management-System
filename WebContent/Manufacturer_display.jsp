...
<div class="header">
  ...
  <a href="index.html" class="logo1"><div class="Head"> <b>MediCrest</b></div><br><br><p>Live healthy. Live happy. Live Longs.</p></a>
 ...
 <br>
     ...
     <br>
      <a href="Manufacturer Details.html" class="previous"> &laquo; Back</a>
<div class="main">
   <center>
  ...
  { 
	  response.setContentType("text/html;charset=UTF-8");
		...
		PreparedStatement ps=con.prepareStatement("select * from Manuf_details");
  ...
  %>
    <tr>
     ...
     <td> <a href="Manufacturer_Update.jsp?edit=<%=rs.getString(1)%> ">Edit</a> </td>
     <td> <a href="Manufacturer_delete.jsp?delete=<%=rs.getString(1)%> ">Delete</a> </td>
